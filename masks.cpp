...
int main(){
    ...
    std :: cout << "bit 0 is: " << static_cast<bool>(var & mask_bit_0)
                << std :: endl;
    std :: cout << "bit 1 is: " << static_cast<bool>(var & mask_bit_1)
                << std :: endl;
    std :: cout << "bit 2 is: " << static_cast<bool>(var & mask_bit_2)
                << std :: endl;
    std :: cout << "bit 3 is: " << static_cast<bool>(var & mask_bit_3)
                << std :: endl;
    std :: cout << "bit 4 is: " << static_cast<bool>(var & mask_bit_4)
                << std :: endl;
    std :: cout << "bit 5 is: " << static_cast<bool>(var & mask_bit_5)
                << std :: endl;
    std :: cout << "bit 6 is: " << static_cast<bool>(var & mask_bit_6)
                << std :: endl;
    std :: cout << "bit 7 is: " << static_cast<bool>(var & mask_bit_7)
                << std :: endl;
    ...
    std :: cout << std :: setw(COLUMN_WIDTH) << "Var : "
            << std :: setw (COLUMN_WIDTH) << std :: bitset<8>(mask_bit_0) << std :: endl;
    std :: cout << std :: setw(COLUMN_WIDTH) << "Var : "
            << std :: setw (COLUMN_WIDTH) << std :: bitset<8>(var) << std :: endl;
	//Toggle bit 0
	std::cout << std::endl;
	...
	std :: cout << "Before Toggle : " << std :: endl;
    std :: cout << std :: setw(COLUMN_WIDTH) << "Var : "
            << std :: setw (COLUMN_WIDTH) << std :: bitset<8>(mask_bit_7) << std :: endl;
    std :: cout << std :: setw(COLUMN_WIDTH) << "Var : "
            << std :: setw (COLUMN_WIDTH) << std :: bitset<8>(var) << std :: endl;
